...
const Layout = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Sidebar */}
      <div className={cn(
        "fixed inset-y-0 left-0 z-50 w-64 bg-gradient-card border-r border-border transform transition-transform duration-300 ease-in-out lg:translate-x-0",
          ...
          <div className="p-4 border-t border-border">
            <div className="flex items-center space-x-3 p-3 rounded-lg bg-muted/50">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground truncate">Computer Science, Y3</p>
              </div>
            </div>
          </div>
        </div>
